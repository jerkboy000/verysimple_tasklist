...
describe('Task Resolver Tests', () => {
  ...
  it('should create task', async () => {
    try {
      const newTask = { id: 2, user_id: 1, name: 'New Task', description: 'Description', note: 'Note', due_date: '2024-01-15', status: 'NOT STARTED' };
  ...
  it('should update task', async () => {
    try {
      const updatedTask = { id: 3, user_id: 1, name: 'Updated Task', description: 'Updated Description', note: 'Updated Note', due_date: '2024-02-01', status: 'IN PROGRESS' };
